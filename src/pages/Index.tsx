  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section id="tools" className="pt-24 pb-16 bg-gradient-to-br from-blue-50 to-white animate-fade-in">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-blue-700">Free & Easy to Use</h3>
                <p>All our tools are completely free with no signup required. Just visit and start using instantly.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-blue-700">Accurate Results</h3>
                <p>Our calculators are designed to provide precise results for all your financial and conversion needs.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-blue-700">Time-Saving</h3>
                <p>Save valuable time with our optimized tools that deliver quick results for your everyday calculations.</p>
              </div>
            </div>
            
            <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 rounded-2xl shadow-md p-8 md:p-12 max-w-5xl mx-auto border border-gray-100">
